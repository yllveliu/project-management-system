...
function DashboardPage({ user: _user }: { user: User | null }) {
    ...
    <div className="w-full max-w-full">
      <div className="flex flex-wrap items-center gap-3 mb-6">
        ...
        <select
          ...
          className="sm:ml-auto w-full sm:w-auto px-3 py-1.5 rounded-lg border border-gray-300 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition"
        >
        ...
        {cards.map((card) => (
          <div
            ...
            className={`bg-white rounded-xl border shadow-sm p-4 ${
              card.cardClass || "border-gray-200"
            }`}
          >
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 w-full max-w-lg">
          ...
          <div className="flex flex-col gap-2">
            {stats.overdue_tasks.map((task) => (
              ...
              >
                <span className="text-sm text-gray-800 break-words">{task.title}</span>
